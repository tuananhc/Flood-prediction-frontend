   ...
   <!--
    <div class="flex flex-wrap text-center lg:text-left">
      <div class="w-full lg:w-6/12 px-4">
        <h4 class="text-xl font-semibold text-white">Be Aware</h4>
        <h5 class="text-lg mt-0 mb-2 text-white">
          Find out more information on these websites:
        </h5>
        <div class="mt-6 lg:mb-0 mb-6">
          ...
          <button
            class="bg-blueGray-800 text-blueGray-800 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
            type="button"
          >
    ...
    <hr class="my-6 border-blueGray-600" />
    -->
